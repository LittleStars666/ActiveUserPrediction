...
def run():
    ...
    train_set1.to_csv("data/training_ld1-16.csv", header=True, index=False)
    ...
    train_set2.to_csv("data/training_ld8-23.csv", header=True, index=False)
    ...
    train_set.to_csv("data/training_lm15-23.csv", header=True, index=False)
    ...
    clf1 = GridSearchCV(LGBMClassifier(**initial_params),
                      param_grid={"n_estimators":[400,800,1200,1600],"num_leaves": [4,8,16,32],"boosting_type":["gbdt"]},
