...
def run(scheme_num=3,file_name="../data/data_v8/training_r"):
    ...
    if scheme_num ==1:
        ...
        if not os.path.isfile("../data/data_merge/training_3m19.csv"):
    ...
    if not os.path.isfile("../data/data_merge/training_3m19.csv"):
        ...
        train_set.to_csv("../data/data_merge/training_3m19.csv", header=True, index=False)
    else:
        train_set = pd.read_csv("../data/data_merge/training_3m19.csv",header=0,index_col=None)
    ...
    user_user_activity_day_b = ["user_user_activity_day_b"+str(i) for i in range(1,12,2)]
    user_user_activity_day_b_res = ["user_user_activity_day_b"+str(i)+"_resInv" for i in range(1,12,2)]
    user_user_activity_day_f = ["user_user_activity_day_f"+str(i) for i in range(1,7,2)]
    user_user_activity_day_f_res = ["user_user_activity_day_f"+str(i)+"_resInv" for i in range(1,7,2)]
    user_user_activity_day_f_span = ["user_user_activity_day_f"+str(i)+"_spanInv" for i in range(1,7,2)]
    user_user_activity_day_f_spanRes = ["user_user_activity_day_f"+str(i)+"_spanResInv" for i in range(1,7,2)]
    user_app_launch_rate_b_resInv = ["user_app_launch_rate_b"+str(i)+"_resInv" for i in range(1,12,2)]
    drop_features = user_user_activity_day_b\
                    +user_user_activity_day_b_res+\
                    user_user_activity_day_f+\
                    user_user_activity_day_f_res+\
                    user_user_activity_day_f_span+\
                    user_user_activity_day_f_spanRes+\
                    user_app_launch_rate_b_resInv
    train_set = train_set.drop(labels=drop_features, axis=1)
    val_set = val_set.drop(labels=drop_features, axis=1)
    val_set2 = val_set2.drop(labels=drop_features, axis=1)
