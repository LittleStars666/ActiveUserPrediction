...
def processing(trainSpan=(1,23),label=True):
    ...
    df_user_register_train["register_day_rate"] = (df_user_register_train.groupby(by=["register_day"])["register_day"].transform("count")).astype(np.uint16)
    df_user_register_train["register_day_type_rate"] = (df_user_register_train.groupby(by=["register_day","register_type"])["register_type"].transform("count")).astype(np.uint16)
    df_user_register_train["register_day_type_ratio"] = (df_user_register_train["register_day_type_rate"]/df_user_register_train["register_day_rate"]).astype(np.float32)
    df_user_register_train["register_day_device_rate"] = (df_user_register_train.groupby(by=["register_day","device_type"])["device_type"].transform("count")).astype(np.uint16)
    df_user_register_train["register_day_device_ratio"] = (df_user_register_train["register_day_device_rate"]/df_user_register_train["register_day_rate"]).astype(np.float32)
    df_user_register_train["register_type_rate"] = (df_user_register_train.groupby(by=["register_type"])["register_type"].transform("count")).astype(np.uint16)
    df_user_register_train["register_type_ratio"] = (df_user_register_train["register_type_rate"]/len(df_user_register_train)).astype(np.float32)
    df_user_register_train["register_type_device"] = (df_user_register_train.groupby(by=["register_type"])["device_type"].transform(lambda x: x.nunique())).astype(np.uint16)
    df_user_register_train["register_type_device_rate"] = (df_user_register_train.groupby(by=["register_type","device_type"])["device_type"].transform("count")).astype(np.uint16)
    df_user_register_train["register_type_device_ratio"] = (df_user_register_train["register_type_device_rate"]/df_user_register_train["register_type_rate"]).astype(np.float32)
    df_user_register_train["device_type_rate"] = (df_user_register_train.groupby(by=["device_type"])["device_type"].transform("count")).astype(np.uint16)
    df_user_register_train["device_type_ratio"] = (df_user_register_train["device_type_rate"]/len(df_user_register_train)).astype(np.float32)
    ...
    df_user_register_train["device_type_register_rate"] = (df_user_register_train.groupby(by=["device_type","register_type"])["register_type"].transform("count")).astype(np.uint16)
    df_user_register_train["device_type_register_ratio"] = (df_user_register_train["device_type_register_rate"]/df_user_register_train["device_type_rate"]).astype(np.float32)
    df_user_register_train["register_day_register_type_device_rate"] = (df_user_register_train.groupby(by=["register_day","register_type","device_type"])["device_type"].transform("count")).astype(np.uint16)
    df_user_register_train["register_day_register_type_device_ratio"] = (df_user_register_train["register_day_register_type_device_rate"]/df_user_register_train["register_day_type_rate"]).astype(np.float32)
    df_user_register_train["register_day_device_type_register_rate"] = (df_user_register_train.groupby(by=["register_day","device_type","register_type"])["register_type"].transform("count")).astype(np.uint16)
    df_user_register_train["register_day_device_type_register_ratio"] = (df_user_register_train["register_day_device_type_register_rate"]/df_user_register_train["register_day_device_rate"]).astype(np.float32)
    ...
    df_app_launch_train["user_app_launch_rate_spanInv"] = (df_app_launch_train["user_app_launch_rate"]*1.0/(trainSpan[1]-trainSpan[0]+1)).astype(np.float32)
    df_app_launch_train["user_app_launch_rate_resInv"] = (df_app_launch_train["user_app_launch_rate"]*1.0/df_app_launch_train["user_app_launch_register_time"]).astype(np.float32)
    df_app_launch_train["user_app_launch_rate_spanResInv"] = (df_app_launch_train["user_app_launch_rate_spanInv"]*1.0/df_app_launch_train["user_app_launch_register_time"]).astype(np.float32)
    df_app_launch_train["user_app_launch_last_time"] = (df_app_launch_train.groupby(by=["user_id"])["app_launch_day"].transform(lambda x:trainSpan[1]-max(x))).astype(np.uint8)
    ...
    for rf in range(1,7,1):
        ...
        df_app_launch_train[rate_name_forward] = (df_app_launch_train.groupby(by=["user_id"])[
            "app_launch_day"].transform(lambda x: count_occurence(x,(trainSpan[0],trainSpan[1]-rf)))).astype(np.uint8)
        rate_name_forward_spanInv = rate_name_forward + "_spanInv"
        app_launch_rate_name_forward_ls.append(rate_name_forward_spanInv)
        df_app_launch_train[rate_name_forward_spanInv] = (df_app_launch_train[rate_name_forward]*1.0/(trainSpan[1]-trainSpan[0]-rf)).astype(np.float32)
        rate_name_forward_resInv= rate_name_forward + "_resInv"
        app_launch_rate_name_forward_ls.append(rate_name_forward_resInv)
        df_app_launch_train[rate_name_forward_resInv] = (df_app_launch_train[rate_name_forward]*1.0/df_app_launch_train["user_app_launch_register_time"]).astype(np.float32)
        ...
        df_app_launch_train[rate_name_forward_spanResInv] = (df_app_launch_train[rate_name_forward_spanInv]*1.0/df_app_launch_train["user_app_launch_register_time"]).astype(np.float32)
    ...
    for rb in range(14,-1,-1):
        ...
        df_app_launch_train[rate_name_backward] = (df_app_launch_train.groupby(by=["user_id"])[
            "app_launch_day"].transform(lambda x: count_occurence(x,(trainSpan[1]-rb,trainSpan[1]+1)))).astype(np.uint8)
        rate_name_backward_resInv = rate_name_backward + "_resInv"
        app_launch_rate_name_backward_ls.append(rate_name_backward_resInv)
        df_app_launch_train[rate_name_backward_resInv] = (df_app_launch_train[rate_name_backward]*1.0/df_app_launch_train["user_app_launch_register_time"]).astype(np.float32)
    
    df_app_launch_train["user_app_launch_gap"] = (df_app_launch_train.groupby(by=["user_id"])[
        "app_launch_day"].transform(lambda x: (len(set(x)) - 1)*1.0/ (max(x) - min(x)) if len(set(x)) > 1 else min(x)*1.0/(trainSpan[1]+min(x)))).astype(np.float32)
    ...
    for g in range(5,12,3):
        ...
        df_app_launch_train[gap_name] = (df_app_launch_train.groupby(by=["user_id"])[
            "app_launch_day"].transform(lambda x: get_gap(x,trainSpan[1],g))).astype(np.float32)
        app_launch_gap_name_ls.append(gap_name)
        
    df_app_launch_train["user_app_launch_var"] = (df_app_launch_train.groupby(by=["user_id"])[
        "app_launch_day"].transform(lambda x: np.var(list(set(x))))).astype(np.float32)
    ...
    for v in range(5,12,3):
        ...
        df_app_launch_train[var_name] = (df_app_launch_train.groupby(by=["user_id"])[
            "app_launch_day"].transform(lambda x: get_var(list(set(x)),trainSpan[1],v))).astype(np.float32)
    ...
    df_video_create_train["user_video_create_register_time"] = (df_video_create_train["register_day"].apply(lambda x: (trainSpan[1] -x+1))).astype(np.uint8)
    ...
    df_video_create_train["user_video_create_rate_spanInv"] = (df_video_create_train["user_video_create_rate"]*1.0/(trainSpan[1]-trainSpan[0]+1)).astype(np.float32)
    df_video_create_train["user_video_create_rate_resInv"] = (df_video_create_train["user_video_create_rate"]*1.0/df_video_create_train["user_video_create_register_time"]).astype(np.float32)
    df_video_create_train["user_video_create_rate_spanResInv"] = (df_video_create_train["user_video_create_rate_spanInv"]*1.0/df_video_create_train["user_video_create_register_time"]).astype(np.float32)
    ...
    df_video_create_train["user_video_create_day_spanInv"] = (df_video_create_train["user_video_create_day"]*1.0/(trainSpan[1]-trainSpan[0]+1)).astype(np.float32)
    df_video_create_train["user_video_create_day_resInv"] = (df_video_create_train["user_video_create_day"]*1.0/df_video_create_train["user_video_create_register_time"]).astype(np.float32)
    df_video_create_train["user_video_create_day_spanResInv"] = (df_video_create_train["user_video_create_day_spanInv"]*1.0/df_video_create_train["user_video_create_register_time"]).astype(np.float32)
    df_video_create_train["user_video_create_frequency"] = (df_video_create_train["user_video_create_rate"]*1.0 / \
                                                           df_video_create_train["user_video_create_day"]).astype(np.float32)
    df_video_create_train["user_video_create_last_time"] = (df_video_create_train.groupby(by=["user_id"])["video_create_day"].transform(lambda x:trainSpan[1]-max(x))).astype(np.uint8)
    ...
    for rf in range(1,7,2):
        ...
        df_video_create_train[frequency_name_forward] =  (df_video_create_train[rate_name_forward]*1.0/df_video_create_train[day_name_forward]).astype(np.float32)
        rate_name_forward_spanInv = rate_name_forward + "_spanInv"
        ...
        df_video_create_train[rate_name_forward_resInv] = (df_video_create_train[rate_name_forward]*1.0 / df_video_create_train[
            "user_video_create_register_time"]).astype(np.float32)
        df_video_create_train[day_name_forward_resInv] = (df_video_create_train[day_name_forward]*1.0 / df_video_create_train[
            "user_video_create_register_time"]).astype(np.float32)
        rate_name_forward_spanResInv = rate_name_forward + "_spanResInv"
        ...
        df_video_create_train[rate_name_forward_spanResInv] = (df_video_create_train[rate_name_forward_spanInv]*1.0/ \
                                                            df_video_create_train["user_video_create_register_time"]).astype(np.float32)
    ...
    for rb in range(12,-1,-3):
        ...
        if rb!=0:
            df_video_create_train[frequency_name_backward] = (df_video_create_train[rate_name_backward]*1.0/df_video_create_train[day_name_backward]).astype(np.float32)
        rate_name_backward_resInv = rate_name_backward + "_resInv"
        ...
        df_video_create_train[rate_name_backward_resInv] = (df_video_create_train[rate_name_backward]*1.0 / df_video_create_train[
            "user_video_create_register_time"]).astype(np.float32)
        df_video_create_train[day_name_backward_resInv] = (df_video_create_train[day_name_backward]*1.0/ df_video_create_train[
            "user_video_create_register_time"]).astype(np.float32)

    df_video_create_train["user_video_create_gap"] = (df_video_create_train.groupby(by=["user_id"])[
        "video_create_day"].transform(
        lambda x: (len(set(x)) - 1)*1.0 / (max(x) - min(x)) if len(set(x)) > 1 else min(x)*1.0 / (trainSpan[1] + min(x)))*1.0).astype(np.float32)
    ...
    for g in range(5, 12, 3):
        ...
        df_video_create_train[gap_name] = (df_video_create_train.groupby(by=["user_id"])[
            "video_create_day"].transform(lambda x: get_gap(x, trainSpan[1], g))*1.0).astype(np.float32)
    ...
    df_video_create_train["user_video_create_day_var"] = (df_video_create_train.groupby(by=["user_id"])[
        "video_create_day"].transform(lambda x: np.var(list(set(x))))*1.0).astype(np.float32)
    df_video_create_train["user_video_create_var"] = (df_video_create_train.groupby(by=["user_id"])[
        "video_create_day"].transform(lambda x: np.var(list(x)))*1.0).astype(np.float32)
    ...
    for v in range(5, 12, 3):
        ...
        df_video_create_train[day_var_name] = (df_video_create_train.groupby(by=["user_id"])[
            "video_create_day"].transform(lambda x: get_var(list(set(x)),trainSpan[1],v))*1.0).astype(np.float32)
        df_video_create_train[var_name] = (df_video_create_train.groupby(by=["user_id"])[
            "video_create_day"].transform(lambda x: get_var(list(x),trainSpan[1],v))*1.0).astype(np.float32)
    ...
    df_user_activity_train["user_user_activity_register_time"] = (df_user_activity_train["register_day"].apply(lambda x: (trainSpan[1] -x+1))).astype(np.uint8)
    ...
    df_user_activity_train["user_user_activity_rate_spanInv"] = (df_user_activity_train["user_user_activity_rate"]*1.0 / (
                trainSpan[1] - trainSpan[0] + 1)).astype(np.float32)
    df_user_activity_train["user_user_activity_rate_resInv"] = (df_user_activity_train["user_user_activity_rate"]*1.0 / \
    ...
    user_authors = df_user_activity_train.loc[df_user_activity_train["user_id"].isin(user_activity_author), "author_id"].tolist()
    user_author_count_dict = Counter(list(user_authors))
    df_user_activity_train["user_in_author_rate"] = df_user_activity_train["user_id"].apply(lambda x: 0 if x not in user_author_count_dict.keys() else user_author_count_dict.get(x)).astype(np.uint16)
    ...
    for rf in range(1,7,1):
        ...
        df_user_activity_train[rate_name_forward_spanResInv] = (df_user_activity_train[rate_name_forward_spanInv]*1.0/ \
                                                              df_user_activity_train["user_user_activity_register_time"]).astype(np.float32)
    ...
    for i in range(0,5):
        ...
        df_user_activity_train[page_name] = (df_user_activity_train.groupby(by=["user_id"])["page"].transform(lambda x: get_ratio(list(x),i))*1.0).astype(np.float32)
    ...
    for i in range(0, 6):
        ...
        df_user_activity_train[action_type_name] = (df_user_activity_train.groupby(by=["user_id"])["action_type"].transform(lambda x: get_ratio(list(x),i))*1.0).astype(np.float32)
    ...
    df_user_activity_train["user_user_activity_var"] = (df_user_activity_train.groupby(by=["user_id"])[
        "user_activity_day"].transform(lambda x: np.var(list(x)))*1.0).astype(np.float32)
    ...
    for v in range(5, 12, 3):
        ...
        df_user_activity_train[var_name] = (df_user_activity_train.groupby(by=["user_id"])[
            "user_activity_day"].transform(lambda x: get_var(list(x),trainSpan[1], v))*1.0).astype(np.float32)
    ...
    df_user_activity_train["user_user_activity_day"] = (df_user_activity_train.groupby(by=["user_id"])[
                                                          "user_activity_day"].transform(lambda x: x.nunique())).astype(
        np.uint8)
    df_user_activity_train["user_user_activity_day_spanInv"] = (df_user_activity_train["user_user_activity_day"]*1.0 / (
                trainSpan[1] - trainSpan[0] + 1)).astype(np.float32)
    df_user_activity_train["user_user_activity_day_resInv"] = (df_user_activity_train["user_user_activity_day"]*1.0 / \
                                                            df_user_activity_train["user_user_activity_register_time"]).astype(np.float32)
    df_user_activity_train["user_user_activity_day_spanResInv"] = (df_user_activity_train["user_user_activity_day_spanInv"]*1.0 / \
                                                                df_user_activity_train["user_user_activity_register_time"]).astype(np.float32)
    df_user_activity_train["user_user_activity_frequency"] = (df_user_activity_train["user_user_activity_rate"]*1.0 / \
                                                           df_user_activity_train["user_user_activity_day"]).astype(np.float32)
    ...
    df_user_activity_train["user_video_rate_spanInv"] = (df_user_activity_train["user_video_rate"]*1.0/(trainSpan[1]-trainSpan[0]+1)).astype(np.float32)
    df_user_activity_train["user_video_rate_resInv"] = (df_user_activity_train["user_video_rate"]*1.0/df_user_activity_train["user_user_activity_register_time"]).astype(np.float32)
    df_user_activity_train["user_video_rate_spanResInv"] = (df_user_activity_train["user_video_rate_spanInv"]*1.0/df_user_activity_train["user_user_activity_register_time"]).astype(np.float32)

    df_user_activity_train["user_author_rate"] = (df_user_activity_train.groupby(by=["user_id"])["author_id"].transform(
        lambda x: x.nunique())).astype(np.uint16)
    df_user_activity_train["user_author_rate_spanInv"] = (df_user_activity_train["user_author_rate"]*1.0/(trainSpan[1]-trainSpan[0]+1)).astype(np.float32)
    df_user_activity_train["user_author_rate_resInv"] = (df_user_activity_train["user_author_rate"]*1.0/df_user_activity_train["user_user_activity_register_time"]).astype(np.float32)
    df_user_activity_train["user_author_rate_spanResInv"] = (df_user_activity_train["user_author_rate_spanInv"]*1.0/df_user_activity_train["user_user_activity_register_time"]).astype(np.float32)
    df_user_activity_train["user_user_activity_last_time"] = (df_user_activity_train.groupby(by=["user_id"])["user_activity_day"].transform(lambda x:trainSpan[1]-max(x))).astype(np.uint8)
    ...
    for rf in range(1,7,1):
        ...
        df_user_activity_train[day_name_forward] = (df_user_activity_train.groupby(by=["user_id"])[
            "user_activity_day"].transform(
            lambda x: count_occurence(set(x), (trainSpan[0], trainSpan[1] - rf)))).astype(np.uint8)
        df_user_activity_train[frequency_name_forward] = (df_user_activity_train[rate_name_forward]*1.0 / df_user_activity_train[day_name_forward]).astype(np.float32)
    ...
    for rb in range(14, -1, -1):
        ...
        df_user_activity_train[day_name_backward] = (df_user_activity_train.groupby(by=["user_id"])[
            ...
            lambda x: count_occurence(set(x), (trainSpan[1] - rb, trainSpan[1] + 1)))).astype(np.uint8)
        if rb!=0:
            df_user_activity_train[frequency_name_backward] = (df_user_activity_train[rate_name_backward]*1.0 /df_user_activity_train[day_name_backward]).astype(np.float32)
        rate_name_backward_resInv = rate_name_backward + "_resInv"
        day_name_backward_resInv = day_name_backward + "_resInv"
    ...
    for g in range(5, 12, 3):
        ...
        df_user_activity_train[gap_name] = (df_user_activity_train.groupby(by=["user_id"])[
            "user_activity_day"].transform(lambda x: get_gap(x, trainSpan[1], g))*1.0).astype(np.float32)
    ...
    df_user_activity_train["user_user_activity_day_var"] = (df_user_activity_train.groupby(by=["user_id"])[
        "user_activity_day"].transform(lambda x: np.var(list(set(x))))*1.0).astype(np.float32)
    ...
    for v in range(5, 12, 3):
        ...
        df_user_activity_train[day_var_name] = (df_user_activity_train.groupby(by=["user_id"])[
            "user_activity_day"].transform(lambda x: get_var(list(set(x)),trainSpan[1], v))*1.0).astype(np.float32)
